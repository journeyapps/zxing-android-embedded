...
public final class CameraManager {
    ...
    public CameraManager(Context context, Bundle options) {
        this.context = context;
        this.configManager = new CameraConfigurationManager(context);
        previewCallback = new PreviewCallback(configManager);

        //get any custom ui options
        isScannerLineEnabled = options.getBoolean(SCANNER_LINE_KEY, true);
        isFrameEnabled = options.getBoolean(FRAME_ENABLED_KEY, true);
        isOverlayEnabled = options.getBoolean(OVERLAY_ENABLED_KEY, true);
    }
