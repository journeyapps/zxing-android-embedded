...
public final class EncodeActivity extends Activity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menuInflater.inflate(R.menu.zxinglegacy_encode, menu);
    boolean useVcard = qrCodeEncoder != null && qrCodeEncoder.isUseVCard();
    int encodeNameResource = useVcard ? R.string.zxinglegacy_menu_encode_mecard : R.string.zxinglegacy_menu_encode_vcard;
  ...
  private void share() {
    ...
    if (!barcodesRoot.exists() && !barcodesRoot.mkdirs()) {
      ...
      showErrorMessage(R.string.zxinglegacy_msg_unmount_usb);
      return;
    }
    ...
    intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.zxinglegacy_app_name) + " - " + encoder.getTitle());
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (bitmap == null) {
        ...
        showErrorMessage(R.string.zxinglegacy_msg_encode_contents_failed);
        qrCodeEncoder = null;
        return;
      }

      ImageView view = (ImageView) findViewById(R.id.zxinglegacy_image_view);
      view.setImageBitmap(bitmap);

      TextView contents = (TextView) findViewById(R.id.zxinglegacy_contents_text_view);
