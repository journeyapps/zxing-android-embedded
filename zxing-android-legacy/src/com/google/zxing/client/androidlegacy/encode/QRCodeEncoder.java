  ...
  private boolean encodeContentsFromZXingIntent(Intent intent) {
    ...
    if (format == null || format == BarcodeFormat.QR_CODE) {
      ...
      if (data != null && data.length() > 0) {
        ...
        title = activity.getString(R.string.zxinglegacy_contents_text);
      }
    }
  ...
  private void encodeQRCodeContents(Intent intent, String type) {
    if (type.equals(Contents.Type.TEXT)) {
      ...
      if (data != null) {
        ...
        displayContents = data;
        title = activity.getString(R.string.zxinglegacy_contents_email);
      }
      ...
      if (data != null) {
        ...
        title = activity.getString(R.string.zxinglegacy_contents_phone);
      }
      ...
      if (data != null) {
        contents = "sms:" + data;
        displayContents = PhoneNumberUtils.formatNumber(data);
        title = activity.getString(R.string.zxinglegacy_contents_sms);
      }
      ...
      if (bundle != null) {
        ...
        if (encoded[1].length() > 0) {
          ...
          title = activity.getString(R.string.zxinglegacy_contents_contact);
        }
      ...
      if (bundle != null) {
        ...
        if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
          ...
          title = activity.getString(R.string.zxinglegacy_contents_location);
        }
      }
    }
  }
