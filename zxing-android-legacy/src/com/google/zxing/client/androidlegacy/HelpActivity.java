...
public final class HelpActivity extends Activity {
  ...
  private static final String BASE_URL =
      "file:///android_asset/zxinglegacy/html-en/";
  ...
  protected void onCreate(Bundle icicle) {
    ...
    webView = (WebView)findViewById(R.id.zxinglegacy_help_contents);
    ...
    backButton = (Button) findViewById(R.id.zxinglegacy_back_button);
    backButton.setOnClickListener(backListener);
    View doneButton = findViewById(R.id.zxinglegacy_done_button);
