...
public final class SearchBookContentsActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    queryTextView = (EditText) findViewById(R.id.zxing_query_text_view);
    ...
    queryButton = findViewById(R.id.zxing_query_button);
    queryButton.setOnClickListener(buttonListener);

    resultListView = (ListView) findViewById(R.id.zxing_result_list_view);
  ...
  private void launchSearch() {
    ...
    if (query != null && !query.isEmpty()) {
      ...
      headerView.setText(R.string.zxing_msg_sbc_searching_book);
  ...
  private final class NetworkTask extends AsyncTask<String,Object,JSONObject> {
    ...
    protected void onPostExecute(JSONObject result) {
      if (result == null) {
        headerView.setText(R.string.zxing_msg_sbc_failed);
      } else {
    ...
    private void handleSearchResults(JSONObject json) {
      try {
        ...
        headerView.setText(getString(R.string.zxing_msg_sbc_results) + " : " + count);
        if (count > 0) {
          ...
          if ("false".equals(searchable)) {
            headerView.setText(R.string.zxing_msg_sbc_book_not_searchable);
          }
          resultListView.setAdapter(null);
        }
    ...
    private SearchBookContentsResult parseResult(JSONObject json) {
      ...
      try {
        ...
        return new SearchBookContentsResult(getString(R.string.zxing_msg_sbc_no_page_returned), "", "", false);
      }
      ...
      if (pageNumber == null || pageNumber.isEmpty()) {
        ...
        pageNumber = getString(R.string.zxing_msg_sbc_page) + ' ' + pageNumber;
      }
      ...
      if (valid) {
        ...
        snippet = '(' + getString(R.string.zxing_msg_sbc_snippet_unavailable) + ')';        
      }
