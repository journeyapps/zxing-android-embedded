...
public final class ShareActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    findViewById(R.id.zxing_share_contact_button).setOnClickListener(contactListener);
    findViewById(R.id.zxing_share_bookmark_button).setOnClickListener(bookmarkListener);
    findViewById(R.id.zxing_share_app_button).setOnClickListener(appListener);
    clipboardButton = findViewById(R.id.zxing_share_clipboard_button);
    clipboardButton.setOnClickListener(clipboardListener);
    findViewById(R.id.zxing_share_text_view).setOnKeyListener(textListener);
  }
