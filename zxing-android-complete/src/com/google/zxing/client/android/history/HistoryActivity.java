...
public final class HistoryActivity extends ListActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if(switchValue == R.id.zxing_menu_history_send) {
        CharSequence history = historyManager.buildHistory();
        Parcelable historyFile = HistoryManager.saveHistory(history.toString());
        if (historyFile == null) {
          AlertDialog.Builder builder = new AlertDialog.Builder(this);
          builder.setMessage(R.string.zxing_msg_unmount_usb);
      ...
      } else if(switchValue == R.id.zxing_menu_history_clear_text) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.zxing_msg_sure);
